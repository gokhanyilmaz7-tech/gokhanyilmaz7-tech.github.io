# Graph Report - gokhanyilmaz7-tech.github  (2026-09-19)

## Corpus Check
- 965 files · ~1,729,642 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1106 nodes · 1963 edges · 68 communities (60 shown, 3 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 91 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `386cb8fc`
...
Cohesion: 0.06
Nodes (80): app, escapeHtml(), formatDate(), load(), render(), currentUser(), hydrateFavorites(), isAdminMode() (+72 more)
...
Cohesion: 0.12
Nodes (45): env, helpers, base64(), decode(), encoder, googleAuth(), json(), readCookie() (+37 more)
...
### Community 55 - "admin-jppI3dUa.js"
Cohesion: 0.53
Nodes (5): e(), n, o(), r(), s()
