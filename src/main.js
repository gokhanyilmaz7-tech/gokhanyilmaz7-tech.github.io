...
app.innerHTML = `
  ...
  <main class="layout">
    <aside class="sidebar">
    <div class="sidebar-heading"><div><p class="eyebrow">İÇİNDEKİLER</p><h2>Mevzuat</h2></div><div class="sidebar-actions"><button id="ipc-open" class="ipc-open" type="button" title="İdari Para Cezaları (2026) tablosunu aç">İPC 2026</button><button id="favorites-open" class="ipc-open favorites-home-open" type="button" title="Favorilerimi aç">☆ Favorilerim</button><button id="report-open" class="ipc-open favorites-home-open" type="button" title="Noksanlık Raporu'nu aç">＋ Noksanlık Raporu</button><button id="external-legislation-open" class="ipc-open favorites-home-open" type="button" title="Mevzuat bağlantıları sayfasını aç">↗ Mevzuat bağlantıları</button></div></div>
...
$('#report-open').addEventListener('click', () => window.open('/noksanlik-raporu.html', '_blank'));
